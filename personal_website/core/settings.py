...
from personal_website.chat.extension import ChatExtension
...
SITE_DATA: dict[str, object] = {
    ...
    "repositories": GitHubClient(token=os.getenv("GH_TOKEN")).get_repositories(),
    "repository": {
...
MARKDOWN = {
    "extensions": ["codehilite", "extra", "smarty", ChatExtension(repository=person_repository)],
    "extension_configs": {
        "smarty": {
            "smart_quotes": False,
        }
...
PLUGINS = [
    ...
    "personal_website.citation.plugin",
]
